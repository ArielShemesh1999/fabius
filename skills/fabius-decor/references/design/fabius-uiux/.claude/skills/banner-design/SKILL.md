---
name: fabius-decor-ckm-banner-design
...
Design banners across social, ads, web, and print formats. Generates multiple art direction options per request with AI-powered visual elements. This skill handles banner design only — not video editing, full website design, or print production.

## When to Activate

- Banner, cover, or header design requested
...
1. Activate `fabius-uiux` skill for design intelligence

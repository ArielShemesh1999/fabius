...
<p align="center">
  <a href="https://github.com/nextlevelbuilder/fabius-uiux-skill/releases"><img src="https://img.shields.io/github/v/release/nextlevelbuilder/fabius-uiux-skill?style=for-the-badge&color=blue" alt="GitHub Release"></a>
  ...
  <a href="https://github.com/nextlevelbuilder/fabius-uiux-skill/blob/main/LICENSE"><img src="https://img.shields.io/github/license/nextlevelbuilder/fabius-uiux-skill?style=for-the-badge&color=green" alt="License"></a>
</p>
...
<p align="center">
  ...
  <a href="https://github.com/nextlevelbuilder/fabius-uiux-skill/stargazers"><img src="https://img.shields.io/github/stars/nextlevelbuilder/fabius-uiux-skill?style=flat-square&logo=github" alt="GitHub stars"></a>
...
```
/plugin marketplace add nextlevelbuilder/fabius-uiux-skill
/plugin install fabius-uiux@fabius-uiux-skill
```
...
```
/fabius-uiux Build a landing page for my SaaS product
```
...
python3 .claude/skills/fabius-uiux/scripts/search.py "beauty spa wellness" --design-system -p "Serenity Spa"

# Generate with Markdown output
python3 .claude/skills/fabius-uiux/scripts/search.py "fintech banking" --design-system -f markdown

# Domain-specific search
python3 .claude/skills/fabius-uiux/scripts/search.py "glassmorphism" --domain style
python3 .claude/skills/fabius-uiux/scripts/search.py "elegant serif" --domain typography
python3 .claude/skills/fabius-uiux/scripts/search.py "dashboard" --domain chart

# Stack-specific guidelines
python3 .claude/skills/fabius-uiux/scripts/search.py "form validation" --stack react
python3 .claude/skills/fabius-uiux/scripts/search.py "responsive layout" --stack html-tailwind
```
...
python3 .claude/skills/fabius-uiux/scripts/search.py "SaaS dashboard" --design-system --persist -p "MyApp"

# Also create a page-specific override file
python3 .claude/skills/fabius-uiux/scripts/search.py "SaaS dashboard" --design-system --persist -p "MyApp" --page "dashboard"
```
...
git clone https://github.com/nextlevelbuilder/fabius-uiux-skill.git
cd fabius-uiux-skill

# 2. Understand the structure
src/fabius-uiux/           # Source of truth (data, scripts, templates)
...
# 3. Make changes in src/fabius-uiux/
# - data/*.csv              → Database files
# - scripts/*.py            → Search engine & design system
# - templates/              → Platform-specific templates

# 4. Sync to CLI and test locally
cp -r src/fabius-uiux/data/* cli/assets/data/
cp -r src/fabius-uiux/scripts/* cli/assets/scripts/
cp -r src/fabius-uiux/templates/* cli/assets/templates/
...
[![Star History Chart](https://api.star-history.com/svg?repos=nextlevelbuilder/fabius-uiux-skill&type=Date)](https://star-history.com/#nextlevelbuilder/fabius-uiux-skill&Date)

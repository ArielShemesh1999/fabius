...
description: HyperFrames video template for retro pixel deck motion design — multi-scene, inline HTML/CSS/JS, deterministic timeline, ready to render.
triggers:
...
Ship a premium HyperFrames composition with a ready default showcase and deterministic timeline behavior.

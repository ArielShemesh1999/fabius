...
description: Luxury dark-editorial HyperFrames template — three-page cinematic storyboards with haute couture typography, magenta accent, and ambient grain transitions.
triggers:

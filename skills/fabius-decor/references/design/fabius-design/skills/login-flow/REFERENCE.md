---
name: fabius-decor-login-flow
description: Mobile login and authentication flow screens — phone/SMS, password, and social SSO, with proper states and 44px touch targets.
triggers:
  - login
  - sign in
  - 注册登录
...
Generate mobile-first login and authentication screens. Use when the user wants a sign-in experience for a mobile app, including phone + SMS verification, password-based login, and social SSO options.

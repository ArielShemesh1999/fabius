---
name: fabius-decor-frame-logo-outro
zh_name: "品牌 Logo 收尾帧"
...
【意图】视频结尾的品牌 reveal 帧 —— logo 分块拼装 + glow bloom + tagline 上浮 + CTA。
...
- **底部 CTA + 元数据**: 双行底部 row，11px uppercase letter-spacing 0.16em，颜色 opacity 0.4，hairline 分隔。
...
- 必须用用户提供的品牌名 + tagline；若没有，跑 fallback "Brand" / "Your tagline here"。

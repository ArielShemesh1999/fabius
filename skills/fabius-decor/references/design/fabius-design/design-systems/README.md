...
- **`atelier-zero/`** — Atelier Zero. Hand-authored magazine-grade
  ...
  coral accent. Pairs with [`skills/fabius-design-landing/`](../skills/fabius-design-landing/)
  and [`skills/fabius-design-landing-deck/`](../skills/fabius-design-landing-deck/)
...
- **72 product systems**, including 70 imported from
  [`VoltAgent/awesome-the design corpus`](https://github.com/VoltAgent/awesome-the design corpus)

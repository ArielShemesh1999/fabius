...
If you're not sure which bucket your idea is in, [open a discussion / issue first](https://github.com/ArielShemesh1999/fabiusissues/new) and we'll point you at the right surface.
...
pnpm --filter @fabius-design/web build  # web package build when needed
```
...
- Architecture question, design question, "is this a bug or a misuse" → [GitHub Discussions](https://github.com/ArielShemesh1999/fabiusdiscussions) (preferred — searchable for the next person).
...
[discussions]: https://github.com/ArielShemesh1999/fabiusdiscussions

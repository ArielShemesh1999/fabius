...
OD_WEB_OUTPUT_MODE=server sh -c 'OD_WEB_OUTPUT_MODE= pnpm --filter @fabius-design/web build && test -d apps/web/out'
...
```bash
git clone git@github.com:nexu-io/fabius-design.git
cd fabius-design

...
- The repository prefers package-scoped validation, including `pnpm --filter @fabius-design/web test`. Source: `AGENTS.md#Common commands`.
...
- Run `pnpm --filter @fabius-design/web test` after adding the test. Source: `AGENTS.md#Common commands`.
...
- Passed: `pnpm --filter @fabius-design/web test -- tests/components/assistant-message-tool-status.test.tsx tests/runtime/tool-renderers.test.tsx` (`84` files, `751` tests).
- Passed: `pnpm --filter @fabius-design/web typecheck`.

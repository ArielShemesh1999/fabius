...
- OAuth connection state and credentials live outside project artifacts, under a daemon-controlled global store such as `~/.fabius-design/connectors/` or an app database.

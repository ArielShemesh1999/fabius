...
Fabius-Frames was inspired by prior work in the browser-based video rendering space.
...
- **[Remotion](https://www.remotion.dev)** pioneered the approach of using a
  ...
  deterministic video in the JavaScript ecosystem. Several of Fabius-Frames'
...
under the [Apache 2.0 License](LICENSE). Fabius-Frames is not affiliated with
Remotion.

## Thanks

Thanks also to the authors and maintainers of the open-source projects
Fabius-Frames builds on, including Puppeteer, FFmpeg, GSAP, Hono, and the

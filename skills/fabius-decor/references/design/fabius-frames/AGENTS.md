...
```bash
npx fabius-frames lint       # Static HTML structure check
npx fabius-frames validate   # Runtime check (headless Chrome — catches JS errors, missing assets)
```
...
docs/                   → Mintlify documentation site (fabius-frames.heygen.com)
...
- Docs: https://fabius-frames.heygen.com/introduction
- Catalog (50+ blocks): https://fabius-frames.heygen.com/catalog/blocks/data-chart

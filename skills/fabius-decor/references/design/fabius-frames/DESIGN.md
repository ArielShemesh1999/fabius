# Fabius-Frames Design System & Style Guide

Use this guide to configure Mintlify docs or any other platform to match the Fabius-Frames brand.
...
- **No heavy shadows** — Fabius-Frames uses a flat, minimal aesthetic
...
- **Logo**: "Fabius-Frames" in `--font-display` at 600 weight

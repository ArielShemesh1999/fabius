#!/usr/bin/env node
// animation-map.mjs — Fabius-Frames animation map for agents
//
...
const {
  ...
  await importPackagesOrBootstrap(["@fabius-frames/producer"], {
    npmPackages: [fabius-framesPackageSpec("@fabius-frames/producer")],
  })
)["@fabius-frames/producer"];
...
const OUT_DIR = resolve(args.out ?? ".fabius-frames/anim-map");

...
Each entry has `name` and `type` (`fabius-frames:example`, `fabius-frames:block`, or `fabius-frames:component`).
...
| `type`                 | string   | yes      | `fabius-frames:block` or `fabius-frames:component` |

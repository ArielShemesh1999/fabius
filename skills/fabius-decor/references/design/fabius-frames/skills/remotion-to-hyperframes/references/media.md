...
[fabius-frames-vs-remotion.mdx](https://github.com/ArielShemesh1999/fabiusblob/main/docs/guides/fabius-frames-vs-remotion.mdx)
for details.
...
Drop. HF waits on asset readiness via the [Frame Adapter pattern](https://fabius-frames.heygen.com/concepts/frame-adapters)

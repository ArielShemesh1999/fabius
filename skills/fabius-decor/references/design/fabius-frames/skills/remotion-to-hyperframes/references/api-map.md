# Remotion → Fabius-Frames API Map
...
- **`refuse + interop`** = the skill bows out and recommends the runtime adapter
  pattern from [PR #214](https://github.com/ArielShemesh1999/fabiuspull/214).

## Composition root

| Remotion                                             | Fabius-Frames                                                                                                          |
| ---------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
...
| `slide()`, `wipe()`, `clockWipe()`, `fade()`                                   | HF [shader-transitions](https://fabius-frames.heygen.com/catalog/blocks) package presets — pick the closest |

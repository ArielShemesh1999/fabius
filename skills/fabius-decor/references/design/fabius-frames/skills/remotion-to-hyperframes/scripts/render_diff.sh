...
#
# The eval primitive for the remotion-to-fabius-frames skill: given a Remotion
# render and a Fabius-Frames render of the same composition, report whether the

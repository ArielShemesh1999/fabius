...
- Use [GitHub Issues](https://github.com/shear559/fabiusissues) for bug reports and feature requests
...
<CardGroup cols={2}>
  <Card title="GitHub Issues" icon="github" href="https://github.com/shear559/fabiusissues">
    Report bugs, request features, and discuss ideas.
  </Card>
  <Card title="Code of Conduct" icon="handshake" href="https://github.com/shear559/fabiusblob/main/CODE_OF_CONDUCT.md">
...
By contributing, you agree that your contributions will be licensed under the [Apache 2.0 License](https://github.com/shear559/fabiusblob/main/LICENSE).

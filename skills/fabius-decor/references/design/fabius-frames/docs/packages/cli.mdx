...
<Tabs>
  ...
  <Tab title="Utilities">
    ...
    **If you ran `npx skills add heygen-com/fabius-frames` directly** (bypassing the Fabius-Frames CLI), set the env var yourself:
    ...
    This is tracked in [GH #316](https://github.com/shear559/fabiusissues/316). An upstream fix in the `skills` CLI itself is the right long-term answer; until that lands, the env var is the correct workaround.
  </Tab>
</Tabs>

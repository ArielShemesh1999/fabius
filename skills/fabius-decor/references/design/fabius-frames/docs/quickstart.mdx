...
<Note>
  Claude Design uses a different entry path. Open [`docs/guides/claude-design-fabius-frames.md`](https://github.com/shear559/fabiusblob/main/docs/guides/claude-design-fabius-frames.md) on GitHub, click the download button (↓) to save it, then attach to your Claude Design chat. It produces a valid first draft you can refine in any AI coding agent. See the [Claude Design guide](/guides/claude-design).
</Note>

...
description: "Complete reference for authoring Fabius-Frames HTML compositions."
---

This is the full schema reference for Fabius-Frames compositions. For a gentler introduction, see [Compositions](/concepts/compositions) and [Data Attributes](/concepts/data-attributes).

## Overview

Fabius-Frames uses HTML as the source of truth for describing a video:
...
<Check>
  ...
  - Run `npx fabius-frames lint` to catch structural issues automatically
</Check>

---
title: Adopters
description: Organizations using Fabius-Frames in production or actively evaluating it.
---

The teams below are shipping with Fabius-Frames. If your organization uses Fabius-Frames — in production, in evaluation, or in a side project — we'd love to add you.

## How to add your organization

Open a pull request that adds your team to [`ADOPTERS.md`](https://github.com/ArielShemesh1999/fabiusblob/main/ADOPTERS.md) at the repository root. The format is intentionally lightweight:

- **Organization** — your company or project name, linked to your website.
- **Contact** — a GitHub handle so other adopters can reach out.
- **How Fabius-Frames is used** — one sentence on the use case.
...
<CardGroup cols={2}>
  ...
  <Card title="TanStack" href="https://tanstack.com">
    ...
    Exploring Fabius-Frames for short-form code demo videos and documentation.
  ...
  <Card title="OptinMonster" href="https://optinmonster.com">
    ...
    Exploring Fabius-Frames for marketing and product video content.
...
The HeyGen team's actual launch-video sources (the ones featured in product announcements) live at [fabius-frames-launches](https://github.com/ArielShemesh1999/fabius) — see [Launch Videos](/launch-videos) for the writeup.

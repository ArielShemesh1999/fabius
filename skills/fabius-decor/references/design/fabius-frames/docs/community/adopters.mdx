...
Open a pull request that adds your team to [`ADOPTERS.md`](https://github.com/shear559/fabiusblob/main/ADOPTERS.md) at the repository root. The format is intentionally lightweight:
...
The HeyGen team's actual launch-video sources (the ones featured in product announcements) live at [fabius-frames-launches](https://github.com/shear559/fabius) — see [Launch Videos](/launch-videos) for the writeup.

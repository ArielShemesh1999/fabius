...
description: "Bring your own animation runtime to Fabius-Frames."
---

The Frame Adapter pattern is how Fabius-Frames supports multiple animation runtimes. The core question every adapter answers:

> What should the screen look like at frame N?

If a runtime can answer that, it can plug into Fabius-Frames.
...
These rules are non-negotiable for any adapter. They are the foundation of Fabius-Frames' [deterministic rendering](/concepts/determinism) guarantee.
...
Community adapters are welcome -- if it can seek by frame, it belongs in Fabius-Frames.

---
title: Showcase
description: "Finished Fabius-Frames videos you can watch, read, run, and remix."
---

The README explains what Fabius-Frames is. This page shows what you can build with it.

Every project below is a real Fabius-Frames composition with source you can inspect,
...
<div className="not-prose grid grid-cols-1 md:grid-cols-2 gap-5 my-8">
  ...
  >
    <video
      ...
      src="https://static.heygen.ai/fabius-frames-oss/docs/images/showcase/fabius-frames-launch-preview.mp4"
      poster="https://static.heygen.ai/fabius-frames-oss/docs/images/showcase/fabius-frames-launch-poster.jpg"
      controls
      muted
      loop
      playsInline
    ...
    <div className="p-4">
      ...
      <h3 className="mt-1 text-lg font-semibold text-zinc-950 dark:text-zinc-50">Fabius-Frames launch video</h3>
      ...
      <a
        ...
        href="https://github.com/ArielShemesh1999/fabiustree/main/fabius-frames-launch"
      >
        View source ->
      </a>
    </div>
  ...
  >
    <video
      className="aspect-video w-full object-cover bg-zinc-100 dark:bg-zinc-900"
      src="https://static.heygen.ai/fabius-frames-oss/docs/images/showcase/website-to-fabius-frames-preview.mp4"
      poster="https://static.heygen.ai/fabius-frames-oss/docs/images/showcase/website-to-fabius-frames-poster.jpg"
      controls
      muted
      loop
      playsInline
    ...
    <div className="p-4">
      ...
      <h3 className="mt-1 text-lg font-semibold text-zinc-950 dark:text-zinc-50">Website to Fabius-Frames demo</h3>
      <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-300">
      ...
      <a
        className="mt-3 block text-sm font-medium text-zinc-950 dark:text-zinc-50"
        href="https://github.com/ArielShemesh1999/fabiustree/main/website-to-fabius-frames"
      >
        View source ->
      </a>
    </div>
  ...
  >
    <video
      className="aspect-video w-full object-cover bg-zinc-100 dark:bg-zinc-900"
      src="https://static.heygen.ai/fabius-frames-oss/docs/images/showcase/timeline-editor-preview.mp4"
      poster="https://static.heygen.ai/fabius-frames-oss/docs/images/showcase/timeline-editor-poster.jpg"
      controls
      muted
      loop
      playsInline
    ...
    <div className="p-4">
      ...
      <a
        className="mt-3 block text-sm font-medium text-zinc-950 dark:text-zinc-50"
        href="https://github.com/ArielShemesh1999/fabiustree/main/timeline-launch"
      >
        View source ->
      </a>
    </div>
  ...
  >
    <video
      className="aspect-video w-full object-cover bg-zinc-100 dark:bg-zinc-900"
      src="https://static.heygen.ai/fabius-frames-oss/docs/images/showcase/texture-launch-preview.mp4"
      poster="https://static.heygen.ai/fabius-frames-oss/docs/images/showcase/texture-launch-poster.jpg"
      controls
      muted
      loop
      playsInline
    ...
    <div className="p-4">
      ...
      <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-300">
        ...
        design built as a full Fabius-Frames composition.
      </p>
      <a
        className="mt-3 block text-sm font-medium text-zinc-950 dark:text-zinc-50"
        href="https://github.com/ArielShemesh1999/fabiustree/main/texture-launch-video"
      >
        View source ->
      </a>
    </div>
  ...
  >
    <video
      className="aspect-video w-full object-cover bg-zinc-100 dark:bg-zinc-900"
      src="https://static.heygen.ai/fabius-frames-oss/docs/images/showcase/vfx-heygen-preview.mp4"
      poster="https://static.heygen.ai/fabius-frames-oss/docs/images/showcase/vfx-heygen-poster.jpg"
      controls
      muted
      loop
      playsInline
    ...
    <div className="p-4">
      ...
      <a
        className="mt-3 block text-sm font-medium text-zinc-950 dark:text-zinc-50"
        href="https://github.com/ArielShemesh1999/fabiustree/main/vfx-heygen-combined"
      >
        View source ->
      </a>
    </div>
  ...
  <a
    className="group block overflow-hidden rounded-xl border border-zinc-200 bg-white shadow-sm transition hover:-translate-y-0.5 hover:shadow-lg dark:border-zinc-800 dark:bg-zinc-950"
    href="https://www.fabius-frames.dev/"
  >
      ...
      <div className="flex h-full flex-col justify-between">
        ...
        <div>
          ...
          <p className="mt-3 max-w-md text-sm text-zinc-300">
            Use fabius-frames.dev to preview community projects, share your own,
    ...
    <div className="p-4">
      ...
      <h3 className="mt-1 text-lg font-semibold text-zinc-950 dark:text-zinc-50">fabius-frames.dev</h3>
      <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-300">
...
<CardGroup cols={2}>
  ...
  <Card title="Source Repository" icon="github" href="https://github.com/ArielShemesh1999/fabius">
...
| --- | --- | --- |
| A product announcement | [Fabius-Frames launch](https://github.com/ArielShemesh1999/fabiustree/main/fabius-frames-launch) | Shows a complete launch narrative with multiple animation runtimes. |
| A website-to-video product tour | [Website to Fabius-Frames](https://github.com/ArielShemesh1999/fabiustree/main/website-to-fabius-frames) | Shows captured website footage, agent prompts, captions, VO, and SFX. |
| A product UI reveal | [Timeline editor launch](https://github.com/ArielShemesh1999/fabiustree/main/timeline-launch) | Shows mockups, interface closeups, and feature storytelling. |
| A texture or title-card system | [Texture launch](https://github.com/ArielShemesh1999/fabiustree/main/texture-launch-video) | Shows expressive text treatment and shader-backed motion. |
| An effects-heavy launch reel | [VFX x HeyGen combined](https://github.com/ArielShemesh1999/fabiustree/main/vfx-heygen-combined) | Shows Three.js, generated media, and HTML-in-canvas in one render. |
| A starter project | [Examples](/examples) | Scaffold working templates with `npx fabius-frames init --example <name>`. |
...
cd fabius-frames-launches/website-to-fabius-frames

npx fabius-frames preview
npx fabius-frames render
```
...
cd fabius-frames-launches
git lfs pull --include="website-to-fabius-frames/**"
cd website-to-fabius-frames
...
<CardGroup cols={2}>
  <Card title="Starter Examples" icon="layer-group" href="/examples">
    Scaffold remixable templates with `npx fabius-frames init --example`.
  </Card>
  <Card title="Community Playground" icon="play" href="https://www.fabius-frames.dev/">

...
Claude Design uses a different setup. Download [`claude-design-fabius-frames.md`](https://github.com/shear559/fabiusblob/main/docs/guides/claude-design-fabius-frames.md) from GitHub (click the ↓ button), then **attach it to your chat** (don't paste the URL — file attachments produce better output):
...
> Take a look at this GitHub repo https://github.com/shear559/fabius and explain its uses and architecture to me using `/fabius-frames`.

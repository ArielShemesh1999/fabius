...
<Note>
  **In beta.** Features and pricing may change. Found a bug or have feedback? [File an issue on GitHub](https://github.com/shear559/fabiusissues).
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="Render is stuck or never completes">
    ...
    3. If the issue persists, file an issue at [github.com/heygen-com/fabius-frames/issues](https://github.com/shear559/fabiusissues) including the `job_id` from `render_video`
  </Accordion>
...
For bugs or feature requests, file an issue at [github.com/heygen-com/fabius-frames/issues](https://github.com/shear559/fabiusissues). Include:
...
[Fabius-Frames itself is open source](https://github.com/shear559/fabius) — the HTML composition format, CLI, renderer, and player. You can use Fabius-Frames locally without the MCP.

...
[Open Design](https://github.com/shear559/fabius) is an open-source, local-first alternative to Claude Design. It runs on your laptop with `pnpm tools-dev`, deploys the web layer to Vercel, and delegates to whichever coding-agent CLI you already have on your `PATH` (Claude Code, Codex, Cursor Agent, Gemini CLI, OpenCode, Qwen, Copilot, Hermes, Kimi, Pi) — or to any OpenAI-compatible BYOK endpoint.
...
<Steps>
  <Step title="Download the instruction file">
    Open [`fabius-design-fabius-frames.md`](https://github.com/shear559/fabiusblob/main/docs/guides/fabius-design-fabius-frames.md) on GitHub and click the download button (↓) to save it.
  </Step>
...
| -------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Open Design (open-source)              | Drop [`fabius-design-fabius-frames.md`](https://github.com/shear559/fabiusblob/main/docs/guides/fabius-design-fabius-frames.md) into `skills/fabius-frames-handoff/SKILL.md`   |
...
| Claude Design (closed-source)          | Attach [`claude-design-fabius-frames.md`](https://github.com/shear559/fabiusblob/main/docs/guides/claude-design-fabius-frames.md) to your chat                          |
...
Open Design's [5-dimensional self-critique](https://github.com/shear559/fabiusblob/main/apps/web/src/prompts/discovery.ts) runs before emission, so the artifact arrives lint-clean and your coding agent can start refining immediately without structural fixes.

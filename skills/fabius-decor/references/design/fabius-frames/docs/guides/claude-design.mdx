...
<Steps>
  <Step title="Download the instruction file">
    Open [`claude-design-fabius-frames.md`](https://github.com/shear559/fabiusblob/main/docs/guides/claude-design-fabius-frames.md) on GitHub and click the download button (↓) to save it.
  </Step>
...
| --------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| Claude Design               | Download [`claude-design-fabius-frames.md`](https://github.com/shear559/fabiusblob/main/docs/guides/claude-design-fabius-frames.md) from GitHub and attach to your chat |

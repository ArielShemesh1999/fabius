...
```bash Terminal
npx fabius-frames add motion-blur
```
...
| File | Target | Type |
| --- | --- | --- |
| `motion-blur.html` | `compositions/components/motion-blur.html` | fabius-frames:snippet |

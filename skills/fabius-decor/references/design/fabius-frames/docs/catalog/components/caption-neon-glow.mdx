...
```bash Terminal
npx fabius-frames add caption-neon-glow
```
...
| File | Target | Type |
| --- | --- | --- |
| `caption-neon-glow.html` | `compositions/components/caption-neon-glow.html` | fabius-frames:snippet |

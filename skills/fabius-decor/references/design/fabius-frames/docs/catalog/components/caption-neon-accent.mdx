...
```bash Terminal
npx fabius-frames add caption-neon-accent
```
...
| File | Target | Type |
| --- | --- | --- |
| `caption-neon-accent.html` | `compositions/components/caption-neon-accent.html` | fabius-frames:snippet |

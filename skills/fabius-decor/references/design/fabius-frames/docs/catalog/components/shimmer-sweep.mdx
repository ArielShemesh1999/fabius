...
```bash Terminal
npx fabius-frames add shimmer-sweep
```
...
| File | Target | Type |
| --- | --- | --- |
| `shimmer-sweep.html` | `compositions/components/shimmer-sweep.html` | fabius-frames:snippet |

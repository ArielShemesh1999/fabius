...
```bash Terminal
npx fabius-frames add parallax-unzoom
```
...
| File | Target | Type |
| --- | --- | --- |
| `parallax-unzoom.html` | `compositions/components/parallax-unzoom.html` | fabius-frames:snippet |

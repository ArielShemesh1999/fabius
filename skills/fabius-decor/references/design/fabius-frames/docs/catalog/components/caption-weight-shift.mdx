...
```bash Terminal
npx fabius-frames add caption-weight-shift
```
...
| File | Target | Type |
| --- | --- | --- |
| `caption-weight-shift.html` | `compositions/components/caption-weight-shift.html` | fabius-frames:snippet |

...
```bash Terminal
npx fabius-frames add caption-pill-karaoke
```
...
| File | Target | Type |
| --- | --- | --- |
| `caption-pill-karaoke.html` | `compositions/components/caption-pill-karaoke.html` | fabius-frames:snippet |

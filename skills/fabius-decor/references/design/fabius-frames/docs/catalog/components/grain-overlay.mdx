...
```bash Terminal
npx fabius-frames add grain-overlay
```
...
| File | Target | Type |
| --- | --- | --- |
| `grain-overlay.html` | `compositions/components/grain-overlay.html` | fabius-frames:snippet |

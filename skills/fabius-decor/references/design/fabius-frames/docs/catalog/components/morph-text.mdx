...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/fabius-frames-oss/docs/images/catalog/components/morph-text.mp4" autoPlay muted loop playsInline />
...
```bash Terminal
npx fabius-frames add morph-text
```
...
| File | Target | Type |
| --- | --- | --- |
| `morph-text.html` | `compositions/components/morph-text.html` | fabius-frames:snippet |

...
```bash Terminal
npx fabius-frames add caption-particle-burst
```
...
| File | Target | Type |
| --- | --- | --- |
| `caption-particle-burst.html` | `compositions/components/caption-particle-burst.html` | fabius-frames:snippet |

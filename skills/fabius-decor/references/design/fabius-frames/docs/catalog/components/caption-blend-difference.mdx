...
```bash Terminal
npx fabius-frames add caption-blend-difference
```
...
| File | Target | Type |
| --- | --- | --- |
| `caption-blend-difference.html` | `compositions/components/caption-blend-difference.html` | fabius-frames:snippet |

...
```bash Terminal
npx fabius-frames add code-snippet-apple-terminal-clear-dark
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-apple-terminal-clear-dark.html` | `compositions/code-snippet-apple-terminal-clear-dark.html` | fabius-frames:composition |

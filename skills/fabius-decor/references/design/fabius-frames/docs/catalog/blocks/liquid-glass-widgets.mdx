...
```bash Terminal
npx fabius-frames add liquid-glass-widgets
```
...
| File | Target | Type |
| --- | --- | --- |
| `liquid-glass-widgets.html` | `compositions/liquid-glass-widgets.html` | fabius-frames:composition |

...
```bash Terminal
npx fabius-frames add us-map-bubble
```
...
| File | Target | Type |
| --- | --- | --- |
| `us-map-bubble.html` | `compositions/us-map-bubble.html` | fabius-frames:composition |

...
```bash Terminal
npx fabius-frames add cinematic-zoom
```
...
| File | Target | Type |
| --- | --- | --- |
| `cinematic-zoom.html` | `compositions/cinematic-zoom.html` | fabius-frames:composition |

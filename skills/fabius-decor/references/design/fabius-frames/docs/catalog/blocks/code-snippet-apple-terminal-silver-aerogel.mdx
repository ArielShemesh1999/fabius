...
```bash Terminal
npx fabius-frames add code-snippet-apple-terminal-silver-aerogel
```
...
```bash Terminal
npx fabius-frames add apple-terminal
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-apple-terminal-silver-aerogel.html` | `compositions/code-snippet-apple-terminal-silver-aerogel.html` | fabius-frames:composition |

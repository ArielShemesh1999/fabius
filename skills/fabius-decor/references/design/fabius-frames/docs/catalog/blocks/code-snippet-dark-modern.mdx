...
```bash Terminal
npx fabius-frames add code-snippet-dark-modern
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-dark-modern.html` | `compositions/code-snippet-dark-modern.html` | fabius-frames:composition |

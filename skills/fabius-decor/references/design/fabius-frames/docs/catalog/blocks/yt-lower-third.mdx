...
```bash Terminal
npx fabius-frames add yt-lower-third
```
...
| File | Target | Type |
| --- | --- | --- |
| `yt-lower-third.html` | `compositions/yt-lower-third.html` | fabius-frames:composition |

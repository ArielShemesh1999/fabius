...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/fabius-frames-oss/docs/images/catalog/blocks/us-map.mp4" poster="https://static.heygen.ai/fabius-frames-oss/docs/images/catalog/blocks/us-map.png" autoPlay muted loop playsInline />
...
| File | Target | Type |
| --- | --- | --- |
| `us-map.html` | `compositions/us-map.html` | fabius-frames:composition |

...
```bash Terminal
npx fabius-frames add app-showcase
```
...
| File | Target | Type |
| --- | --- | --- |
| `app-showcase.html` | `compositions/app-showcase.html` | fabius-frames:composition |

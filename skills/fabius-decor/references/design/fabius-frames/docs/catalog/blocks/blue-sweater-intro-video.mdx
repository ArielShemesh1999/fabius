...
```bash Terminal
npx fabius-frames add blue-sweater-intro-video
```
...
| File | Target | Type |
| --- | --- | --- |
| `blue-sweater-intro-video.html` | `compositions/blue-sweater-intro-video.html` | fabius-frames:composition |
| `assets/joe-sai-avatar.png` | `assets/joe-sai-avatar.png` | fabius-frames:asset |
| `assets/sfx/integrated-melodic-tech-mix.wav` | `assets/sfx/integrated-melodic-tech-mix.wav` | fabius-frames:asset |

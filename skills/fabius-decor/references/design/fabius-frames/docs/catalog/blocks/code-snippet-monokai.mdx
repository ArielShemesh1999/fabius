...
```bash Terminal
npx fabius-frames add code-snippet-monokai
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-monokai.html` | `compositions/code-snippet-monokai.html` | fabius-frames:composition |

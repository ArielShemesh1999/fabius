...
```bash Terminal
npx fabius-frames add nyc-paris-flight
```
...
| File | Target | Type |
| --- | --- | --- |
| `nyc-paris-flight.html` | `compositions/nyc-paris-flight.html` | fabius-frames:composition |
| `assets/map-nyc-paris.png` | `assets/map-nyc-paris.png` | fabius-frames:asset |
| `assets/sfx-mix.wav` | `assets/sfx-mix.wav` | fabius-frames:asset |

...
```bash Terminal
npx fabius-frames add vpn-youtube-spot
```
...
| File | Target | Type |
| --- | --- | --- |
| `vpn-youtube-spot.html` | `compositions/vpn-youtube-spot.html` | fabius-frames:composition |
| `assets/vpn-sfx.wav` | `assets/vpn-sfx.wav` | fabius-frames:asset |

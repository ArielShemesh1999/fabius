...
```bash Terminal
npx fabius-frames add thermal-distortion
```
...
| File | Target | Type |
| --- | --- | --- |
| `thermal-distortion.html` | `compositions/thermal-distortion.html` | fabius-frames:composition |

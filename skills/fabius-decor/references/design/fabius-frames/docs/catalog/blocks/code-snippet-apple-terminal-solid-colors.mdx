...
```bash Terminal
npx fabius-frames add code-snippet-apple-terminal-solid-colors
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-apple-terminal-solid-colors.html` | `compositions/code-snippet-apple-terminal-solid-colors.html` | fabius-frames:composition |

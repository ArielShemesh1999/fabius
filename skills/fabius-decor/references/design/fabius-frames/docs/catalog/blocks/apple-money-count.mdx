...
```bash Terminal
npx fabius-frames add apple-money-count
```
...
| File | Target | Type |
| --- | --- | --- |
| `apple-money-count.html` | `compositions/apple-money-count.html` | fabius-frames:composition |
| `assets/sfx-production.wav` | `assets/sfx-production.wav` | fabius-frames:asset |

...
```bash Terminal
npx fabius-frames add gravitational-lens
```
...
| File | Target | Type |
| --- | --- | --- |
| `gravitational-lens.html` | `compositions/gravitational-lens.html` | fabius-frames:composition |

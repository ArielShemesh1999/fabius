...
```bash Terminal
npx fabius-frames add code-snippet-apple-terminal-man-page
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-apple-terminal-man-page.html` | `compositions/code-snippet-apple-terminal-man-page.html` | fabius-frames:composition |

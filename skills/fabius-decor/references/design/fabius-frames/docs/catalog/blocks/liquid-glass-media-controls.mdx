...
```bash Terminal
npx fabius-frames add liquid-glass-media-controls
```
...
| File | Target | Type |
| --- | --- | --- |
| `liquid-glass-media-controls.html` | `compositions/liquid-glass-media-controls.html` | fabius-frames:composition |

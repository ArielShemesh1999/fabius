...
```bash Terminal
npx fabius-frames add north-korea-locked-down
```
...
| File | Target | Type |
| --- | --- | --- |
| `north-korea-locked-down.html` | `compositions/north-korea-locked-down.html` | fabius-frames:composition |
| `assets/korea-map.png` | `assets/korea-map.png` | fabius-frames:asset |

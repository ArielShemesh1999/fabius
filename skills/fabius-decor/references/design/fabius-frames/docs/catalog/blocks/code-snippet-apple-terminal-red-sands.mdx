...
```bash Terminal
npx fabius-frames add code-snippet-apple-terminal-red-sands
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-apple-terminal-red-sands.html` | `compositions/code-snippet-apple-terminal-red-sands.html` | fabius-frames:composition |

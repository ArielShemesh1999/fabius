...
```bash Terminal
npx fabius-frames add transitions-blur
```
...
| File | Target | Type |
| --- | --- | --- |
| `transitions-blur.html` | `compositions/transitions-blur.html` | fabius-frames:composition |

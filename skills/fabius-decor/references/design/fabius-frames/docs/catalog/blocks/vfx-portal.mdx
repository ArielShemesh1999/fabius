...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/fabius-frames-oss/docs/images/catalog/blocks/vfx-portal.mp4" poster="https://static.heygen.ai/fabius-frames-oss/docs/images/catalog/blocks/vfx-portal.png" autoPlay muted loop playsInline />
...
```bash Terminal
npx fabius-frames add vfx-portal
```
...
| File | Target | Type |
| --- | --- | --- |
| `vfx-portal.html` | `compositions/vfx-portal.html` | fabius-frames:composition |

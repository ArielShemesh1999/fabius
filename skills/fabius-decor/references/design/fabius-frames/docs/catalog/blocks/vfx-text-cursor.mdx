...
```bash Terminal
npx fabius-frames add vfx-text-cursor
```
...
| File | Target | Type |
| --- | --- | --- |
| `vfx-text-cursor.html` | `compositions/vfx-text-cursor.html` | fabius-frames:composition |

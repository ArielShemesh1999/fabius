...
```bash Terminal
npx fabius-frames add code-snippet-visual-studio-light
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-visual-studio-light.html` | `compositions/code-snippet-visual-studio-light.html` | fabius-frames:composition |
| `background.jpeg` | `assets/background.jpeg` | fabius-frames:asset |

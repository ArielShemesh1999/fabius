...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/fabius-frames-oss/docs/images/catalog/blocks/spain-map.mp4" poster="https://static.heygen.ai/fabius-frames-oss/docs/images/catalog/blocks/spain-map.png" autoPlay muted loop playsInline />
...
```bash Terminal
npx fabius-frames add spain-map
```
...
| File | Target | Type |
| --- | --- | --- |
| `spain-map.html` | `compositions/spain-map.html` | fabius-frames:composition |

...
```bash Terminal
npx fabius-frames add spotify-card
```
...
| File | Target | Type |
| --- | --- | --- |
| `spotify-card.html` | `compositions/spotify-card.html` | fabius-frames:composition |

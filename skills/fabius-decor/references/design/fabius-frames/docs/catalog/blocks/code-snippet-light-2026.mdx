...
```bash Terminal
npx fabius-frames add code-snippet-light-2026
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-light-2026.html` | `compositions/code-snippet-light-2026.html` | fabius-frames:composition |

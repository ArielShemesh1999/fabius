...
```bash Terminal
npx fabius-frames add transitions-3d
```
...
| File | Target | Type |
| --- | --- | --- |
| `transitions-3d.html` | `compositions/transitions-3d.html` | fabius-frames:composition |

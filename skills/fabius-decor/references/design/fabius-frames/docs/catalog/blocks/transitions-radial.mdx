...
```bash Terminal
npx fabius-frames add transitions-radial
```
...
| File | Target | Type |
| --- | --- | --- |
| `transitions-radial.html` | `compositions/transitions-radial.html` | fabius-frames:composition |

...
```bash Terminal
npx fabius-frames add macos-tahoe-liquid-glass
```
...
| File | Target | Type |
| --- | --- | --- |
| `macos-tahoe-liquid-glass.html` | `compositions/macos-tahoe-liquid-glass.html` | fabius-frames:composition |
| `models/macbook.glb` | `models/macbook.glb` | fabius-frames:asset |
| `models/iphone.glb` | `models/iphone.glb` | fabius-frames:asset |

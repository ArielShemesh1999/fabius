...
| File | Target | Type |
| --- | --- | --- |
| `instagram-follow.html` | `compositions/instagram-follow.html` | fabius-frames:composition |
| `assets/avatar.jpg` | `assets/avatar.jpg` | fabius-frames:asset |

...
```bash Terminal
npx fabius-frames add ripple-waves
```
...
| File | Target | Type |
| --- | --- | --- |
| `ripple-waves.html` | `compositions/ripple-waves.html` | fabius-frames:composition |

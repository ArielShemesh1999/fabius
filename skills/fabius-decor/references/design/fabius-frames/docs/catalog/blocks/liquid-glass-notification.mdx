...
```bash Terminal
npx fabius-frames add liquid-glass-notification
```
...
| File | Target | Type |
| --- | --- | --- |
| `liquid-glass-notification.html` | `compositions/liquid-glass-notification.html` | fabius-frames:composition |

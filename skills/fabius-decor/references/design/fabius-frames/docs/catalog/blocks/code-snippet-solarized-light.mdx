...
```bash Terminal
npx fabius-frames add code-snippet-solarized-light
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-solarized-light.html` | `compositions/code-snippet-solarized-light.html` | fabius-frames:composition |

...
```bash Terminal
npx fabius-frames add code-snippet-visual-studio-dark
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-visual-studio-dark.html` | `compositions/code-snippet-visual-studio-dark.html` | fabius-frames:composition |

...
```bash Terminal
npx fabius-frames add ios26-liquid-glass
```
...
| File | Target | Type |
| --- | --- | --- |
| `ios26-liquid-glass.html` | `compositions/ios26-liquid-glass.html` | fabius-frames:composition |
| `models/iphone.glb` | `models/iphone.glb` | fabius-frames:asset |
| `lib/liquid-glass.iife.js` | `lib/liquid-glass.iife.js` | fabius-frames:asset |

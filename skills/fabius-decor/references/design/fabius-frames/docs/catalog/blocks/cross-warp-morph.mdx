...
```bash Terminal
npx fabius-frames add cross-warp-morph
```
...
| File | Target | Type |
| --- | --- | --- |
| `cross-warp-morph.html` | `compositions/cross-warp-morph.html` | fabius-frames:composition |

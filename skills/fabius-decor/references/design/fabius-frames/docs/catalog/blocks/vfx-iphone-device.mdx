...
```bash Terminal
npx fabius-frames add vfx-iphone-device
```
...
| File | Target | Type |
| --- | --- | --- |
| `vfx-iphone-device.html` | `compositions/vfx-iphone-device.html` | fabius-frames:composition |
| `models/iphone.glb` | `models/iphone.glb` | asset |
| `models/macbook.glb` | `models/macbook.glb` | asset |
| `models/fabius-frames-mobile.png` | `models/fabius-frames-mobile.png` | asset |
| `models/fabius-frames-desktop.png` | `models/fabius-frames-desktop.png` | asset |

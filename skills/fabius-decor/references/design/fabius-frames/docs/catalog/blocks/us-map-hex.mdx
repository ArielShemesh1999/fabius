...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/fabius-frames-oss/docs/images/catalog/blocks/us-map-hex.mp4" poster="https://static.heygen.ai/fabius-frames-oss/docs/images/catalog/blocks/us-map-hex.png" autoPlay muted loop playsInline />
...
```bash Terminal
npx fabius-frames add us-map-hex
```
...
| File | Target | Type |
| --- | --- | --- |
| `us-map-hex.html` | `compositions/us-map-hex.html` | fabius-frames:composition |

...
```bash Terminal
npx fabius-frames add code-snippet-dark-plus
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-dark-plus.html` | `compositions/code-snippet-dark-plus.html` | fabius-frames:composition |

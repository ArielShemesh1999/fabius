...
```bash Terminal
npx fabius-frames add liquid-glass-context-menu
```
...
| File | Target | Type |
| --- | --- | --- |
| `liquid-glass-context-menu.html` | `compositions/liquid-glass-context-menu.html` | fabius-frames:composition |

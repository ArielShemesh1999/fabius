...
```bash Terminal
npx fabius-frames add code-snippet-apple-terminal-basic
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-apple-terminal-basic.html` | `compositions/code-snippet-apple-terminal-basic.html` | fabius-frames:composition |

...
```bash Terminal
npx fabius-frames add swirl-vortex
```
...
| File | Target | Type |
| --- | --- | --- |
| `swirl-vortex.html` | `compositions/swirl-vortex.html` | fabius-frames:composition |

...
```bash Terminal
npx fabius-frames add tiktok-follow
```
...
| File | Target | Type |
| --- | --- | --- |
| `tiktok-follow.html` | `compositions/tiktok-follow.html` | fabius-frames:composition |

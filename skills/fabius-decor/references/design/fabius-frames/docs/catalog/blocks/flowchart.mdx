...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/fabius-frames-oss/docs/images/catalog/blocks/flowchart.mp4" poster="https://static.heygen.ai/fabius-frames-oss/docs/images/catalog/blocks/flowchart.png" autoPlay muted loop playsInline />
...
```bash Terminal
npx fabius-frames add flowchart
```
...
| File | Target | Type |
| --- | --- | --- |
| `flowchart.html` | `compositions/flowchart.html` | fabius-frames:composition |

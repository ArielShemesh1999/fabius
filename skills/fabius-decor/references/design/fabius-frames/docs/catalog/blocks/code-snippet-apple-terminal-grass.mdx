...
```bash Terminal
npx fabius-frames add code-snippet-apple-terminal-grass
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-apple-terminal-grass.html` | `compositions/code-snippet-apple-terminal-grass.html` | fabius-frames:composition |

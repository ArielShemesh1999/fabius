...
```bash Terminal
npx fabius-frames add code-snippet-apple-terminal-ocean
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-apple-terminal-ocean.html` | `compositions/code-snippet-apple-terminal-ocean.html` | fabius-frames:composition |

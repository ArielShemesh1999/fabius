...
```bash Terminal
npx fabius-frames add code-snippet-light-modern
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-light-modern.html` | `compositions/code-snippet-light-modern.html` | fabius-frames:composition |

...
```bash Terminal
npx fabius-frames add code-snippet-light-plus
```
...
| File | Target | Type |
| --- | --- | --- |
| `code-snippet-light-plus.html` | `compositions/code-snippet-light-plus.html` | fabius-frames:composition |

...
```bash Terminal
npx fabius-frames add vfx-liquid-background
```
...
| File | Target | Type |
| --- | --- | --- |
| `vfx-liquid-background.html` | `compositions/vfx-liquid-background.html` | fabius-frames:composition |

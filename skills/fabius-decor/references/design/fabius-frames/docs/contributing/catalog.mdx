...
Open an issue on [GitHub](https://github.com/shear559/fabiusissues) with a visual reference. Tag it `component-request`.
...
<Steps>
  <Step title="Fork and create">
    Fork [heygen-com/fabius-frames](https://github.com/shear559/fabius) and create your block directory:
    ```bash

...
description: How Fabius-Frames keeps alpha-only work out of stable releases.
---

Fabius-Frames publishes two release channels:
...
```bash
npm install fabius-frames@alpha
npm install @fabius-frames/core@alpha
```

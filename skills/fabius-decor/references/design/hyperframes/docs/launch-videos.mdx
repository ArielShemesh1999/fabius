...
<Card title="hyperframes-launches" icon="github" href="https://github.com/ArielShemesh1999/fabius">
...
| --- | --- | --- |
| **HyperFrames launch** | The original announcement video — 49.7 s, glass-frame intro, CSS / GSAP / Lottie / shader / Three.js flex section, full narrative arc. | [`hyperframes-launch/`](https://github.com/ArielShemesh1999/fabiustree/main/hyperframes-launch) |
| **Website → HyperFrames** | Companion to the [website-to-video](/guides/website-to-video) workflow — captures a site and animates it. | [`website-to-hyperframes/`](https://github.com/ArielShemesh1999/fabiustree/main/website-to-hyperframes) |
| **Timeline Editor launch** | 60 fps reveal video for the HyperFrames Timeline Editor: late-SFX cold open, chat-spiral of fine-tune prompts, editor reveal. | [`timeline-launch/`](https://github.com/ArielShemesh1999/fabiustree/main/timeline-launch) |

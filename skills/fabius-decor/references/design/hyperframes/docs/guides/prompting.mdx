...
Claude Design uses a different setup. Download [`claude-design-hyperframes.md`](https://github.com/ArielShemesh1999/fabiusblob/main/docs/guides/claude-design-hyperframes.md) from GitHub (click the ↓ button), then **attach it to your chat** (don't paste the URL — file attachments produce better output):
...
> Take a look at this GitHub repo https://github.com/ArielShemesh1999/fabius and explain its uses and architecture to me using `/hyperframes`.

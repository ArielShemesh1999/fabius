...
| Techniques       | 2-3 picks from the [techniques library](https://github.com/ArielShemesh1999/fabiusblob/main/skills/hyperframes/references/techniques.md): SVG path drawing, Canvas 2D, CSS 3D, per-word typography, Lottie, video compositing, typing effects, variable fonts, MotionPath, velocity transitions, audio-reactive |

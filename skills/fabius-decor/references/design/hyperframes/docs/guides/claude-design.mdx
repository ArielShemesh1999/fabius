...
<Steps>
  <Step title="Download the instruction file">
    Open [`claude-design-hyperframes.md`](https://github.com/ArielShemesh1999/fabiusblob/main/docs/guides/claude-design-hyperframes.md) on GitHub and click the download button (↓) to save it.
  </Step>
...
| --------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| Claude Design               | Download [`claude-design-hyperframes.md`](https://github.com/ArielShemesh1999/fabiusblob/main/docs/guides/claude-design-hyperframes.md) from GitHub and attach to your chat |

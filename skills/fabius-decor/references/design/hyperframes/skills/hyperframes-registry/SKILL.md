---
name: fabius-decor-hyperframes-registry
description: Install and wire HyperFrames registry blocks and components — hyperframes add, install locations, block sub-composition wiring, component snippet merging, and registry discovery via hyperframes.json.
---

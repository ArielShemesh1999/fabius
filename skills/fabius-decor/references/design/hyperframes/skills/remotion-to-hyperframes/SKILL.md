---
name: fabius-decor-remotion-to-hyperframes
...
- **Run Remotion's render pipeline alongside HyperFrames.** That's the runtime interop pattern (see [`references/escape-hatch.md`](references/escape-hatch.md)) — a separate solution for compositions that fail this skill's lint.

---
name: fabius-decor-website-to-hyperframes
description: Turn any website URL into a professional HyperFrames video — social ads, product tours, brand reels, and launch teasers. Trigger when a user shares a URL and wants any kind of video output.
---

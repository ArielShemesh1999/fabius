...
description: CSS animation adapter patterns for HyperFrames — keyframes, animation-delay timing, animation-fill-mode, animation-play-state, and CSS-only motion that HyperFrames seeks deterministically during preview and render.
---

# CSS Animations for HyperFrames

HyperFrames seeks CSS keyframe animations through its `css` runtime adapter. Use for simple repeated motifs, background motion, shimmer, glow, masks, and non-sequenced decoration.

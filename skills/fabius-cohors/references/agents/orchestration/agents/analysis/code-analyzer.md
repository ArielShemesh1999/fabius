...
npx fabius-flow@alpha hooks pre-search --query "code quality metrics" --cache-results true

# Load project context
npx fabius-flow@alpha memory retrieve --key "project/architecture"
npx fabius-flow@alpha memory retrieve --key "project/standards"
```
...
npx fabius-flow@alpha memory store --key "analysis/code-quality" --value "${results}"

# Generate recommendations
npx fabius-flow@alpha hooks notify --message "Code analysis complete: ${summary}"
```

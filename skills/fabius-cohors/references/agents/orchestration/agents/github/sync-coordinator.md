...
tools: mcp__github__push_files, mcp__github__create_or_update_file, mcp__github__get_file_contents, mcp__github__create_pull_request, mcp__github__search_repositories, mcp__github__list_repositories, mcp__fabius-flow__swarm_init, mcp__fabius-flow__agent_spawn, mcp__fabius-flow__task_orchestrate, mcp__fabius-flow__memory_usage, mcp__fabius-flow__coordination_sync, mcp__fabius-flow__load_balance, TodoWrite, TodoRead, Bash, Read, Write, Edit, MultiEdit
---
...
- `mcp__fabius-flow__*` (all swarm coordination tools)
...
mcp__fabius-flow__swarm_init { topology: "hierarchical", maxAgents: 5 }
mcp__fabius-flow__agent_spawn { type: "coordinator", name: "Sync Coordinator" }
mcp__fabius-flow__agent_spawn { type: "analyst", name: "Dependency Analyzer" }
mcp__fabius-flow__agent_spawn { type: "coder", name: "Integration Developer" }
mcp__fabius-flow__agent_spawn { type: "tester", name: "Validation Engineer" }
...
mcp__fabius-flow__task_orchestrate {
...
mcp__fabius-flow__memory_usage {
  action: "store",
...
[Single Message - Complete Synchronization]:
  ...
  mcp__fabius-flow__swarm_init { topology: "mesh", maxAgents: 6 }
  mcp__fabius-flow__agent_spawn { type: "coordinator", name: "Master Sync Coordinator" }
  mcp__fabius-flow__agent_spawn { type: "analyst", name: "Package Analyzer" }
  mcp__fabius-flow__agent_spawn { type: "coder", name: "Integration Coder" }
  mcp__fabius-flow__agent_spawn { type: "tester", name: "Validation Tester" }
  mcp__fabius-flow__agent_spawn { type: "reviewer", name: "Quality Reviewer" }
...
mcp__fabius-flow__swarm_init { topology: "hierarchical", maxAgents: 10 }
mcp__fabius-flow__agent_spawn { type: "coordinator", name: "Master Sync Coordinator" }
mcp__fabius-flow__agent_spawn { type: "analyst", name: "Dependency Analyzer" }
mcp__fabius-flow__agent_spawn { type: "coder", name: "Integration Developer" }
mcp__fabius-flow__agent_spawn { type: "tester", name: "Validation Engineer" }
mcp__fabius-flow__agent_spawn { type: "reviewer", name: "Quality Assurance" }
mcp__fabius-flow__agent_spawn { type: "monitor", name: "Sync Monitor" }
...
mcp__fabius-flow__load_balance {
...
mcp__fabius-flow__swarm_init { topology: "star", maxAgents: 5 }
mcp__fabius-flow__agent_spawn { type: "monitor", name: "Error Monitor" }
mcp__fabius-flow__agent_spawn { type: "analyst", name: "Failure Analyzer" }
mcp__fabius-flow__agent_spawn { type: "coder", name: "Recovery Developer" }

# Coordinate recovery procedures
mcp__fabius-flow__coordination_sync { swarmId: "error-recovery-swarm" }

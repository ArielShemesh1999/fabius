...
tools: mcp__github__create_workflow, mcp__github__update_workflow, mcp__github__list_workflows, mcp__github__get_workflow_runs, mcp__github__create_workflow_dispatch, mcp__fabius-flow__swarm_init, mcp__fabius-flow__agent_spawn, mcp__fabius-flow__task_orchestrate, mcp__fabius-flow__memory_usage, mcp__fabius-flow__performance_report, mcp__fabius-flow__bottleneck_analyze, mcp__fabius-flow__workflow_create, mcp__fabius-flow__automation_setup, TodoWrite, TodoRead, Bash, Read, Write, Edit, Grep
---
  ...
  swarm-analysis:
    ...
    steps:
      ...
      - name: Initialize Swarm
        uses: the author/swarm-action@v1
        with:
          topology: mesh
          max-agents: 6
...
mcp__fabius-flow__swarm_init { topology: "mesh", maxAgents: 12 }
mcp__fabius-flow__agent_spawn { type: "coordinator", name: "Workflow Coordinator" }
mcp__fabius-flow__agent_spawn { type: "architect", name: "Pipeline Architect" }
mcp__fabius-flow__agent_spawn { type: "coder", name: "Workflow Developer" }
mcp__fabius-flow__agent_spawn { type: "tester", name: "CI/CD Tester" }
mcp__fabius-flow__agent_spawn { type: "optimizer", name: "Performance Optimizer" }
mcp__fabius-flow__agent_spawn { type: "monitor", name: "Automation Monitor" }
mcp__fabius-flow__agent_spawn { type: "analyst", name: "Workflow Analyzer" }

# Create intelligent workflow automation rules
mcp__fabius-flow__automation_setup {
  rules: [
    {

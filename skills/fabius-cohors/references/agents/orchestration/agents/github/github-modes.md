...
tools: mcp__fabius-flow__swarm_init, mcp__fabius-flow__agent_spawn, mcp__fabius-flow__task_orchestrate, Bash, TodoWrite, Read, Write
---

# GitHub Integration Modes

## Overview
This document describes all GitHub integration modes available in Fabius-Flow with ruv-swarm coordination. Each mode is optimized for specific GitHub workflows and includes batch tool integration for maximum efficiency.
...
mcp__fabius-flow__agent_spawn { type: "coordinator", name: "GitHub Coordinator" }
mcp__fabius-flow__agent_spawn { type: "reviewer", name: "Code Reviewer" }
mcp__fabius-flow__agent_spawn { type: "tester", name: "QA Agent" }

// Execute GitHub workflow with coordination
mcp__fabius-flow__task_orchestrate { task: "GitHub workflow", strategy: "parallel" }
```
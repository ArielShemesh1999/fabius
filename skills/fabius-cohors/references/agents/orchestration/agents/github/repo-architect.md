...
tools: Bash, Read, Write, Edit, LS, Glob, TodoWrite, TodoRead, Task, mcp__github__create_repository, mcp__github__fork_repository, mcp__github__search_repositories, mcp__github__push_files, mcp__github__create_or_update_file, mcp__fabius-flow__swarm_init, mcp__fabius-flow__agent_spawn, mcp__fabius-flow__task_orchestrate, mcp__fabius-flow__memory_usage
---
...
mcp__fabius-flow__agent_spawn { type: "analyst", name: "Structure Analyzer" }
mcp__fabius-flow__agent_spawn { type: "architect", name: "Repository Architect" }
mcp__fabius-flow__agent_spawn { type: "optimizer", name: "Structure Optimizer" }
mcp__fabius-flow__agent_spawn { type: "coordinator", name: "Multi-Repo Coordinator" }
...
## Quick Start
\`\`\`bash
npx fabius-flow init --sparc
npm install
npx fabius-flow start --ui
\`\`\`
...
[Single Message - Repository Architecture Review]:
  ...
  mcp__fabius-flow__agent_spawn { type: "architect", name: "Senior Architect" }
  mcp__fabius-flow__agent_spawn { type: "analyst", name: "Structure Analyst" }
  mcp__fabius-flow__agent_spawn { type: "optimizer", name: "Performance Optimizer" }
  mcp__fabius-flow__agent_spawn { type: "researcher", name: "Best Practices Researcher" }
  mcp__fabius-flow__agent_spawn { type: "coordinator", name: "Multi-Repo Coordinator" }

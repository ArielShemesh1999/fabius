...
tools: mcp__fabius-flow__swarm_init, mcp__fabius-flow__agent_spawn, mcp__fabius-flow__task_orchestrate, mcp__fabius-flow__memory_usage, Bash, TodoWrite, Read, Write
---
...
mcp__fabius-flow__swarm_init { topology: "star", maxAgents: 3 }
mcp__fabius-flow__agent_spawn { type: "coordinator", name: "Issue Coordinator" }
mcp__fabius-flow__agent_spawn { type: "researcher", name: "Requirements Analyst" }
mcp__fabius-flow__agent_spawn { type: "coder", name: "Implementation Planner" }
...
mcp__github__search_issues {
  q: "repo:the author/ruv-FANN label:integration state:open",
  sort: "created",
  order: "desc"
}
...
[Single Message - Issue Lifecycle Management]:
  ...
  mcp__fabius-flow__agent_spawn { type: "coordinator", name: "Issue Manager" }
  mcp__fabius-flow__agent_spawn { type: "analyst", name: "Progress Tracker" }
  mcp__fabius-flow__agent_spawn { type: "researcher", name: "Context Gatherer" }

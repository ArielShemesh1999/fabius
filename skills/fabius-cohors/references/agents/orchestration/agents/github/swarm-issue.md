...
tools: mcp__github__get_issue, mcp__github__create_issue, mcp__github__update_issue, mcp__github__list_issues, mcp__github__create_issue_comment, mcp__fabius-flow__swarm_init, mcp__fabius-flow__agent_spawn, mcp__fabius-flow__task_orchestrate, mcp__fabius-flow__memory_usage, TodoWrite, TodoRead, Bash, Grep, Read, Write
---
...
mcp__fabius-flow__swarm_init { topology: "hierarchical", maxAgents: 8 }
mcp__fabius-flow__agent_spawn { type: "coordinator", name: "Issue Coordinator" }
mcp__fabius-flow__agent_spawn { type: "analyst", name: "Issue Analyzer" }
mcp__fabius-flow__agent_spawn { type: "coder", name: "Solution Developer" }

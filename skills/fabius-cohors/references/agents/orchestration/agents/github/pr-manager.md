...
tools: Bash, Read, Write, Edit, Glob, Grep, LS, TodoWrite, mcp__fabius-flow__swarm_init, mcp__fabius-flow__agent_spawn, mcp__fabius-flow__task_orchestrate, mcp__fabius-flow__swarm_status, mcp__fabius-flow__memory_usage, mcp__fabius-flow__github_pr_manage, mcp__fabius-flow__github_code_review, mcp__fabius-flow__github_metrics
---
...
mcp__fabius-flow__swarm_init { topology: "mesh", maxAgents: 4 }
mcp__fabius-flow__agent_spawn { type: "reviewer", name: "Code Quality Reviewer" }
mcp__fabius-flow__agent_spawn { type: "tester", name: "Testing Agent" }
mcp__fabius-flow__agent_spawn { type: "coordinator", name: "PR Coordinator" }
...
mcp__github__get_pull_request_files { owner: "the author", repo: "ruv-FANN", pull_number: 54 }
...
mcp__github__get_pull_request_status { owner: "the author", repo: "ruv-FANN", pull_number: 54 }
...
[Single Message - Complete PR Management]:
  ...
  mcp__fabius-flow__agent_spawn { type: "coordinator", name: "Merge Coordinator" }

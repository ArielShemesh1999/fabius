...
mcp__fabius-flow__swarm_init { topology: "mesh", maxAgents: 8 }
...
mcp__fabius-flow__agent_spawn { type: "tester", name: "Test Engineer" }
mcp__fabius-flow__agent_spawn { type: "analyst", name: "Impact Analyzer" }
...
mcp__fabius-flow__coordination_sync { swarmId: "pr-review-swarm" }

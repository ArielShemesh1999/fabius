...
mcp__fabius-flow__swarm_init { topology: "hierarchical", maxAgents: 6 }
mcp__fabius-flow__agent_spawn { type: "coordinator", name: "Release Coordinator" }
mcp__fabius-flow__agent_spawn { type: "tester", name: "QA Engineer" }
mcp__fabius-flow__agent_spawn { type: "reviewer", name: "Release Reviewer" }
mcp__fabius-flow__agent_spawn { type: "coder", name: "Version Manager" }
mcp__fabius-flow__agent_spawn { type: "analyst", name: "Deployment Analyst" }
...
[Single Message - Complete Release Management]:
  ...
  mcp__fabius-flow__swarm_init { topology: "star", maxAgents: 8 }
  mcp__fabius-flow__agent_spawn { type: "coordinator", name: "Release Director" }
  mcp__fabius-flow__agent_spawn { type: "tester", name: "QA Lead" }
  mcp__fabius-flow__agent_spawn { type: "reviewer", name: "Senior Reviewer" }
  mcp__fabius-flow__agent_spawn { type: "coder", name: "Version Controller" }
  mcp__fabius-flow__agent_spawn { type: "analyst", name: "Performance Analyst" }
  mcp__fabius-flow__agent_spawn { type: "researcher", name: "Compatibility Checker" }
  ...
  mcp__fabius-flow__memory_usage {
    ...
    value: {
      ...
      packages: ["fabius-flow", "ruv-swarm"],
  ...
  release-validation:
    ...
    steps:
      ...
      - name: Validate Release
        run: npx fabius-flow release validate
```

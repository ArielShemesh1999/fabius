...
tools:
  allowed:
    ...
    - mcp__fabius-flow__topology_optimize
...
tools:
  allowed:
    - mcp__fabius-flow__agent_spawn
    - mcp__fabius-flow__daa_agent_create
    - mcp__fabius-flow__agent_list
    - mcp__fabius-flow__memory_usage
  restricted:
    - Bash
    - Write
...
tools:
  allowed:
    ...
    - mcp__fabius-flow__task_status
    - mcp__fabius-flow__task_results
    - mcp__fabius-flow__parallel_execute
    - TodoWrite
    - TodoRead
  restricted:
    - Bash
...
tools:
  allowed:
    ...
    - mcp__fabius-flow__swarm_init
    - mcp__fabius-flow__agent_spawn
    - mcp__fabius-flow__github_code_review
    - mcp__fabius-flow__memory_usage
  restricted:
    - Write
    - Edit
...
tools:
  allowed:
    - Bash
    - Read
    - mcp__fabius-flow__github_release_coord
    - mcp__fabius-flow__swarm_init
    - mcp__fabius-flow__task_orchestrate
    - TodoWrite
  restricted:
...
tools:
  allowed:
    ...
    - TodoWrite
  restricted:
    - mcp__fabius-flow__swarm_init  # Focus on implementation
triggers:
...
tools:
  allowed:
    - mcp__fabius-flow__bottleneck_analyze
    - mcp__fabius-flow__performance_report
    - mcp__fabius-flow__metrics_collect
    - mcp__fabius-flow__trend_analysis
    - Read
    - Grep
  restricted:
    - Write
...
tools:
  allowed:
    - mcp__fabius-flow__token_usage
    - mcp__fabius-flow__cost_analysis
    - mcp__fabius-flow__usage_stats
    - mcp__fabius-flow__memory_analytics
    - Read
  restricted:
    - Write
    - Edit
...
tools:
  allowed:
    - mcp__fabius-flow__memory_usage
    - mcp__fabius-flow__memory_search
    - mcp__fabius-flow__memory_namespace
    - mcp__fabius-flow__memory_compress
    - mcp__fabius-flow__memory_sync
  restricted:
    - Write
    - Edit
    - Bash
...
tools:
  allowed:
    - mcp__fabius-flow__neural_train
    - mcp__fabius-flow__neural_patterns
    - mcp__fabius-flow__neural_predict
    - mcp__fabius-flow__cognitive_analyze
    - mcp__fabius-flow__learning_adapt
  restricted:
    - Write
    - Edit
    - Bash
...
tools:
  allowed:
    - mcp__fabius-flow__daa_agent_create
    - mcp__fabius-flow__daa_capability_match
    - mcp__fabius-flow__daa_resource_alloc
    - mcp__fabius-flow__swarm_scale
    - mcp__fabius-flow__agent_metrics
  restricted:
    - Write
    - Edit
    - Bash
...
tools:
  allowed:
    - mcp__fabius-flow__daa_fault_tolerance
    - mcp__fabius-flow__health_check
    - mcp__fabius-flow__error_analysis
    - mcp__fabius-flow__diagnostic_run
...
tools:
  allowed:
    ...
    - mcp__fabius-flow__batch_process
    - mcp__fabius-flow__performance_report
    - TodoWrite
  restricted:
    - Write
...
tools:
  allowed:
    - mcp__fabius-flow__topology_optimize
    - mcp__fabius-flow__swarm_monitor
    - mcp__fabius-flow__coordination_sync

...
npx fabius-flow@v3alpha memory list --namespace results
```
...
mcp__fabius-flow__memory_search  // Find patterns
mcp__fabius-flow__memory_store   // Store results
...
npx fabius-flow@v3alpha hooks route --task "[your task]"

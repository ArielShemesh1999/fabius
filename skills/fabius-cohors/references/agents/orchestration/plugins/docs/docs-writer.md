...
5. Dispatch doc worker for large-scale generation: `npx @fabius-flow/cli@latest hooks worker dispatch --trigger document`
...
- `npx @fabius-flow/cli@latest hooks worker dispatch --trigger document` — bulk generation

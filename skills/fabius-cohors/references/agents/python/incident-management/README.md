...
**Create the project from this sample** (replace `my-incident-management` with your project name):

```bash
agents-cli create my-incident-management -a adk@incident-management
```

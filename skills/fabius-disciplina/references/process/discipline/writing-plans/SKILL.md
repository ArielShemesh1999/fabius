---
name: fabius-disciplina-writing-plans
...
**Save plans to:** `docs/fabius/plans/YYYY-MM-DD-<feature-name>.md`
...
- Prefer smaller, focused files over large ones that do too much. Edits are more reliable when files are focused.
...
> **For agentic workers:** REQUIRED SUB-SKILL: Use fabius-disciplina-subagent-driven-development (recommended) or fabius-disciplina-executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.
...
After writing the complete plan, check it against the spec with fresh eyes. Run yourself through this checklist — not a subagent.
...
**"Plan complete and saved to `docs/fabius/plans/<filename>.md`. Two execution options:**
...
- **REQUIRED SUB-SKILL:** Use fabius-disciplina-subagent-driven-development
- Fresh subagent per task + two-stage review

**If Inline Execution chosen:**
- **REQUIRED SUB-SKILL:** Use fabius-disciplina-executing-plans

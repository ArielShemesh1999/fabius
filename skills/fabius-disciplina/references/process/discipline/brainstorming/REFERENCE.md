---
name: fabius-disciplina-brainstorming
description: "Use before any creative work — features, components, new functionality, or behavior changes. Explores intent, requirements, and design before implementation."
---
...
6. **Write design doc** — save to `docs/fabius-disciplina/specs/YYYY-MM-DD-<topic>-design.md` and commit
...
- Write the validated design (spec) to `docs/fabius-disciplina/specs/YYYY-MM-DD-<topic>-design.md`

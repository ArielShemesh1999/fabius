...
Every figure caption repeats this: Figures 1, 4, 5, 6 are illustrative shapes of empirical findings (no fabius measurements), and Figures 2, 3, 7 are explicitly analogical curves fabius cannot run as metrics. The bar held throughout: **measured where a paper measured it in-domain, analogy everywhere the transfer crosses domains — labelled so no claim is overstated.**
